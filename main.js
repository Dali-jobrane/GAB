...
let createEmbed = (info, sv, online) => {
    ...
    .setThumbnail('https://cdn.discordapp.com/attachments/867106145604468736/868949244181086218/TLmtalogo.png')
    .setTimestamp()
    .addFields(
...
let editor = () => {
    ...
    for(let sv of servers){
        ...
        client.user.setActivity(`${info.pl}/${info.maxpl} IN game`)
